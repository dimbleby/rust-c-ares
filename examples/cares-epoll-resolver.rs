...
mod unix {
    ...
    // A thread that keeps going processing file descriptors for c-ares, until 
    // it is asked to stop.
    ...
    fn process_ares_fds(ares_channel: Arc<Mutex<c_ares::Channel>>) {
        ...
        loop {
            ...
            // map those requests onto the epoll file descriptor.
