...
impl ::std::default::Default for ares_options {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub enum hostent { }
pub enum ares_channeldata { }
...
impl ::std::default::Default for ares_in6_addr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl ::std::default::Default for ares_addrttl {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl ::std::default::Default for ares_addr6ttl {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl ::std::default::Default for ares_txt_reply {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl Union_Unnamed2 {
    pub unsafe fn addr4(&mut self) -> *mut in_addr {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn addr6(&mut self) -> *mut ares_in6_addr {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
extern "C" {
    ...
    pub fn ares_gethostbyaddr(channel: ares_channel,
                              ...
                              callback: ares_host_callback,
                              arg: *mut ::std::os::raw::c_void);
    pub fn ares_getnameinfo(channel: ares_channel, sa: *const sockaddr,
                            salen: ares_socklen_t,
                            flags: ::std::os::raw::c_int,
                            callback: ares_nameinfo_callback,
                            arg: *mut ::std::os::raw::c_void);
    pub fn ares_fds(channel: *const ares_channeldata, read_fds: *mut fd_set,
                    write_fds: *mut fd_set) -> ::std::os::raw::c_int;
    pub fn ares_getsock(channel: *const ares_channeldata,
                        socks: *mut ares_socket_t,
                        numsocks: ::std::os::raw::c_int)
     -> ::std::os::raw::c_int;
    pub fn ares_timeout(channel: ares_channel, maxtv: *mut timeval,
                        tv: *mut timeval) -> *mut timeval;
